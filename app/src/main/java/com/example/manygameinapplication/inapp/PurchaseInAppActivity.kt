...
import com.example.manygameinapplication.ui.MainActivity
import com.example.manygameinapplication.ui.MainApp
...
//        assert productDetails.getSubscriptionOfferDetails() != null;
    ...
    override fun onBackPressed() {
        startActivity(Intent(this@PurchaseInAppActivity, MainActivity::class.java))
        finish()
    }
}